...
const tableData = {
  'wp-two-one': [
    ...
    },
    {
      ...
      description:
        'Red – 66% or more responders picked the following skill. Yellow – Between 33% and 65% responders picked the following skill. Green – Less than 33% picked the following skill. ',
      levels: {
        above: 66,
        below: 33,
      },
